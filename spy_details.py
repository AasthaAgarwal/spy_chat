...
spy = Spy('Aastha', 'Ms.', 19, 4.9)

# details of some existing friends
friend_one = Spy('Sakshi, ', 'Ms.', 19, 4.8)
friend_two = Spy('Prinsh, ', 'Mr.', 20, 4.6)
friend_three = Spy('Dipanshi, ', 'Ms.',19, 4.7)
friend_four = Spy('Akshita, ', 'Ms.',19, 4.7)
friend_five = Spy('Abhishek, ', 'Mr.',20, 4.7)
